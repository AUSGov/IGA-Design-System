import { _ as _export_sfc, d as resolveComponent, o as openBlock, c as createElementBlock, e as createVNode, k as withCtx, F as Fragment, a as createBaseVNode, j as createTextVNode, l as createStaticVNode } from "./app.555e31a1.js";
const _sfc_main = {};
...
const _hoisted_3 = /* @__PURE__ */ createStaticVNode('<h2 id="table" tabindex="-1"><a class="header-anchor" href="#table" aria-hidden="true">#</a> Table</h2><div><table class="table"><thead class="table-light"><tr><th scope="col">#</th><th scope="col">Table Header</th><th scope="col">Table Header</th></tr></thead><tbody><tr><th scope="row">1</th><td>Table Body</td><td>Table Body</td></tr><tr><th scope="row">2</th><td>Table Body</td><td>Table Body</td></tr></tbody></table></div><h2 id="demo" tabindex="-1"><a class="header-anchor" href="#demo" aria-hidden="true">#</a> Demo</h2>', 3);
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("div", { class: "language-html ext-html line-numbers-mode" }, [
...
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("div", { class: "language-javascript ext-js" }, [
...
function _sfc_render(_ctx, _cache) {
  ...
  const _component_ImageMap = resolveComponent("ImageMap");
  ...
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    createVNode(_component_ImageMap, {
