import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, b as createBaseVNode, F as Fragment, l as renderList, a as createVNode } from "./app.7c3b1c07.js";
const _sfc_main = {
  props: {
    contents: {
      type: Array,
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.contents, (card) => {
        return openBlock(), createElementBlock("div", _hoisted_3, [
          createVNode(_component_Card, {
            image: card.image,
            title: card.title,
            "components-link": card.componentsLink,
            "link-url": card.linkUrl,
            "link-text": card.linkText,
            compact: $props.compact
          }, null, 8, ["image", "title", "components-link", "link-url", "link-text", "compact"])
        ]);
      }), 256))
    ])
  ]);
