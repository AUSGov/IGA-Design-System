import { _ as _export_sfc, f as defineComponent, g as useThemeLocaleData, z as useRoute, j as computed, r as resolveComponent, h as unref, o as openBlock, c as createElementBlock, F as Fragment, l as renderList, m as createCommentVNode, b as createBaseVNode, t as toDisplayString, a as createVNode, d as createTextVNode } from "./app.70bda88c.js";
const _hoisted_1 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const subMenu = computed(() => {
      const parentMenu = [...themeLocale.value.navbar].reverse().find((item) => item.children && isActive(item));
      if (!parentMenu) {
        return null;
      }
      let result = [];
