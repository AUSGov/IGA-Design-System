import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, a as createVNode, b as createBaseVNode, d as createTextVNode } from "./app.70bda88c.js";
const _sfc_main = {};
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("p", { class: "h4 fw-normal" }, "Our digital front door guides users through an integrated and accessible experience, providing context to the breadth of news, stories, achievements, and engagement opportunities.", -1);
const _hoisted_4 = /* @__PURE__ */ createTextVNode();
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("p", { class: "h4 fw-normal mb-4" }, "This modular approach brings to life our information architecture that prioritises critical and timely information, while also presenting information according to user needs and interests.", -1);
...
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("h3", {
  id: "our-six-governance-principles-from-the-website-governance-framework",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#our-six-governance-principles-from-the-website-governance-framework",
    "aria-hidden": "true"
  }, "#"),
  /* @__PURE__ */ createTextVNode(" Our six governance principles from the website governance framework")
], -1);
const _hoisted_13 = /* @__PURE__ */ createTextVNode();
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("p", null, "We incorporate the six principles in our design system:", -1);
...
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("h3", {
  id: "how-this-translates-to-our-design-system",
  tabindex: "-1"
}, [
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#how-this-translates-to-our-design-system",
    "aria-hidden": "true"
  }, "#"),
  /* @__PURE__ */ createTextVNode(" How this translates to our design system")
], -1);
const _hoisted_18 = /* @__PURE__ */ createTextVNode();
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("p", null, "To visually capture these six principles, we\u2019ve defined key design system principles:", -1);
...
function _sfc_render(_ctx, _cache) {
  ...
  const _component_BigList = resolveComponent("BigList");
  const _component_Columns = resolveComponent("Columns");
  const _component_RowLinkList = resolveComponent("RowLinkList");
  return openBlock(), createElementBlock("div", null, [
    ...
    _hoisted_14,
    _hoisted_15,
    createVNode(_component_BigList, { list: [
    ...
    _hoisted_22,
    _hoisted_23,
    createVNode(_component_RowLinkList, { list: [
      {
