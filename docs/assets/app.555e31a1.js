...
var clientAppEnhance4 = ({ app }) => {
  app.component("ArrowsList", defineAsyncComponent(() => __vitePreload(() => import("./ArrowsList.fa89dc7f.js"), true ? [] : void 0))), app.component("Card", defineAsyncComponent(() => __vitePreload(() => import("./Card.d98e5fd0.js"), true ? [] : void 0))), app.component("Cards", defineAsyncComponent(() => __vitePreload(() => import("./Cards.ba4fc60b.js"), true ? [] : void 0))), app.component("ColorTile", defineAsyncComponent(() => __vitePreload(() => import("./ColorTile.5763a16a.js"), true ? [] : void 0))), app.component("ColorTiles", defineAsyncComponent(() => __vitePreload(() => import("./ColorTiles.7765adf1.js"), true ? [] : void 0))), app.component("Columns", defineAsyncComponent(() => __vitePreload(() => import("./Columns.5b3779e1.js"), true ? [] : void 0))), app.component("ImageMap", defineAsyncComponent(() => __vitePreload(() => import("./ImageMap.fb03b595.js"), true ? [] : void 0))), app.component("SubMenuCards", defineAsyncComponent(() => __vitePreload(() => import("./SubMenuCards.9e302a3c.js"), true ? [] : void 0))), app.component("TwoCards", defineAsyncComponent(() => __vitePreload(() => import("./TwoCards.03f27a5b.js"), true ? [] : void 0)));
};
