  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createTextVNode(toDisplayString(unref(activeItem)) + " ", 1),
                ...
                child.children ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  createBaseVNode("h4", _hoisted_3$3, [
                    child.link ? (openBlock(), createBlock(_sfc_main$j, {
                      key: 0,
                      item: child
                    }, null, 8, ["item"])) : (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(child.text), 1))
                  ]),
...
const _hoisted_2 = { id: "sidebar-left" };
const _hoisted_3 = { id: "sidebar-right" };
