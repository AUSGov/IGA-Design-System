...
const _hoisted_1$c = ["aria-selected"];
...
var clientAppEnhance4 = ({ app }) => {
  app.component("ArrowRight", defineAsyncComponent(() => __vitePreload(() => import("./ArrowRight.d61a16f2.js"), true ? [] : void 0))), app.component("ArrowsList", defineAsyncComponent(() => __vitePreload(() => import("./ArrowsList.eb3a56ff.js"), true ? [] : void 0))), app.component("Card", defineAsyncComponent(() => __vitePreload(() => import("./Card.f25c0c9e.js"), true ? [] : void 0))), app.component("Cards", defineAsyncComponent(() => __vitePreload(() => import("./Cards.675cbef4.js"), true ? [] : void 0))), app.component("CodeDemo", defineAsyncComponent(() => __vitePreload(() => import("./CodeDemo.d52839b4.js"), true ? [] : void 0))), app.component("ColorTile", defineAsyncComponent(() => __vitePreload(() => import("./ColorTile.8365c854.js"), true ? [] : void 0))), app.component("ColorTiles", defineAsyncComponent(() => __vitePreload(() => import("./ColorTiles.020d0d99.js"), true ? [] : void 0))), app.component("Columns", defineAsyncComponent(() => __vitePreload(() => import("./Columns.45c148d5.js"), true ? [] : void 0))), app.component("OrderedList", defineAsyncComponent(() => __vitePreload(() => import("./OrderedList.961b148b.js"), true ? [] : void 0))), app.component("SubMenuCards", defineAsyncComponent(() => __vitePreload(() => import("./SubMenuCards.408a82e7.js"), true ? [] : void 0))), app.component("TwoCards", defineAsyncComponent(() => __vitePreload(() => import("./TwoCards.8d29732b.js"), true ? [] : void 0))), app.component("TypographyRow", defineAsyncComponent(() => __vitePreload(() => import("./TypographyRow.7867b2a1.js"), true ? [] : void 0)));
};
...
const _hoisted_1$b = ["href", "rel", "target", "aria-label"];
...
const _hoisted_7$3 = { class: "navbar-dropdown-subtitle" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_2$9, toDisplayString(unref(item).text), 1),
          _hoisted_3$8
        ], 8, _hoisted_1$a),
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_5$3, toDisplayString(unref(item).text), 1),
        ...
        createVNode(_sfc_main$c, null, {
          default: withCtx(() => [
            withDirectives(createBaseVNode("ul", _hoisted_6$3, [
                ...
                return openBlock(), createElementBlock("li", {
                  ...
                  child.children ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("h4", _hoisted_7$3, [
                      child.link ? (openBlock(), createBlock(_sfc_main$d, {
                        key: 0,
                        item: child,
    ...
    const useNavbarSelectLanguage = () => {
      ...
      return computed(() => {
        ...
        const languageDropdown = {
          ...
          ariaLabel: (_b2 = themeLocale.value.selectLanguageAriaLabel) != null ? _b2 : "unkown language",
          children: localePaths.map((targetLocalePath) => {
            var _a3, _b3, _c, _d, _e, _f;
            const targetSiteLocale = (_b3 = (_a3 = siteLocale.value.locales) == null ? void 0 : _a3[targetLocalePath]) != null ? _b3 : {};
      ...
      return unref(navbarLinks).length ? (openBlock(), createElementBlock("nav", _hoisted_1$9, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(navbarLinks), (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            item.link ? (openBlock(), createBlock(_sfc_main$d, {
              key: 0,
              item
            }, null, 8, ["item"])) : (openBlock(), createBlock(_sfc_main$b, {
              key: 1,
              item
            }, null, 8, ["item"]))
          ]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        withDirectives((openBlock(), createElementBlock("svg", _hoisted_2$8, _hoisted_12, 512)), [
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function getCssValue(el, property) {
      var _a2, _b2, _c;
      const val = (_c = (_b2 = (_a2 = el == null ? void 0 : el.ownerDocument) == null ? void 0 : _a2.defaultView) == null ? void 0 : _b2.getComputedStyle(el, null)) == null ? void 0 : _c[property];
...
const _hoisted_4$5 = { class: "meta-item-label" };
const _hoisted_5$2 = { class: "meta-item-info" };
const _hoisted_6$2 = {
  key: 2,
  class: "meta-item contributors"
};
const _hoisted_7$2 = { class: "meta-item-label" };
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const useEditNavLink = () => {
      ...
      return computed(() => {
        var _a2, _b2, _c;
        const showEditLink = (_b2 = (_a2 = frontmatter.value.editLink) != null ? _a2 : themeLocale2.value.editLink) != null ? _b2 : true;
        if (!showEditLink) {
          return null;
        }
        const {
    ...
    const useLastUpdated = () => {
      ...
      return computed(() => {
        var _a2, _b2, _c, _d;
        const showLastUpdated = (_b2 = (_a2 = frontmatter.value.lastUpdated) != null ? _a2 : themeLocale2.value.lastUpdated) != null ? _b2 : true;
        if (!showLastUpdated)
          return null;
    ...
    const useContributors = () => {
      ...
      return computed(() => {
        var _a2, _b2, _c, _d;
        const showContributors = (_b2 = (_a2 = frontmatter.value.contributors) != null ? _a2 : themeLocale2.value.contributors) != null ? _b2 : true;
        if (!showContributors)
          return null;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("footer", _hoisted_1$6, [
        ...
        unref(lastUpdated) ? (openBlock(), createElementBlock("div", _hoisted_3$5, [
          createBaseVNode("span", _hoisted_4$5, toDisplayString(unref(themeLocale).lastUpdatedText) + ": ", 1),
        ...
        unref(contributors) && unref(contributors).length ? (openBlock(), createElementBlock("div", _hoisted_6$2, [
          createBaseVNode("span", _hoisted_7$2, toDisplayString(unref(themeLocale).contributorsText) + ": ", 1),
      ...
      return unref(prevNavLink) || unref(nextNavLink) ? (openBlock(), createElementBlock("nav", _hoisted_1$5, [
        createBaseVNode("p", _hoisted_2$5, [
          unref(prevNavLink) ? (openBlock(), createElementBlock("span", _hoisted_3$4, [
            createVNode(_sfc_main$d, { item: unref(prevNavLink) }, null, 8, ["item"])
          ])) : createCommentVNode("", true),
          unref(nextNavLink) ? (openBlock(), createElementBlock("span", _hoisted_4$4, [
            createVNode(_sfc_main$d, { item: unref(nextNavLink) }, null, 8, ["item"])
          ])) : createCommentVNode("", true)
        ])
      ])) : createCommentVNode("", true);
    };
...
const _hoisted_4$3 = { class: "navbar-dropdown-subitem-wrapper" };
                ...
                createBaseVNode("ul", _hoisted_4$3, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(child.children, (grandchild) => {
                    return openBlock(), createElementBlock("li", {
                      ...
                      createVNode(_sfc_main$d, { item: grandchild }, null, 8, ["item"])
                    ]);
                  }), 128))
                ])
              ], 64)) : (openBlock(), createBlock(_sfc_main$d, {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    createBaseVNode("div", _hoisted_2$2, [
      createBaseVNode("div", _hoisted_3$2, [
        ...
        _ctx.$frontmatter.description ? (openBlock(), createElementBlock("p", _hoisted_4$2, toDisplayString(_ctx.$frontmatter.description), 1)) : createCommentVNode("", true)
      ])
    ])
  ]);
}
...
const _hoisted_1$1 = { class: "c-page-footer container-fluid" };
const _hoisted_2$1 = { class: "row" };
const _hoisted_3$1 = { class: "col-12 col-md-6 col-lg-8" };
const _hoisted_4$1 = { class: "footer-wrap" };
const _hoisted_5$1 = /* @__PURE__ */ createBaseVNode("h2", null, "Feedback?", -1);
const _hoisted_6$1 = /* @__PURE__ */ createBaseVNode("p", { class: "lead-text" }, "We welcome all feedback, designs, or ideas in order to produce the best possible experience for our users. If you\u2019re interested in contributing, submit your ideas to the team.", -1);
const _hoisted_7$1 = {
  href: "#",
...
var clientAppEnhance5 = defineClientAppEnhance(({ app }) => {
  app.component("ParentPage", _sfc_main);
});
...
export { useDarkMode as A, _sfc_main$d as B, h as C, withBase as D, ClientOnly as E, Fragment as F, toRefs as G, useRouter as H, isActiveSidebarItem as I, ref as J, withDirectives as K, vShow as L, _sfc_main$c as M, useSidebarItems as N, _sfc_main$a as O, onMounted as P, onUnmounted as Q, _sfc_main$7 as R, PageHeader as S, _sfc_main$3 as T, _sfc_main$4 as U, Transition as V, PageFooter as W, usePageData as X, _export_sfc as _, arrowRight as a, createBaseVNode as b, createElementBlock as c, createVueApp, resolveComponent as d, createCommentVNode as e, createBlock as f, createVNode as g, renderSlot as h, createTextVNode as i, normalizeStyle as j, withModifiers as k, defineComponent as l, useRoute as m, normalizeClass as n, openBlock as o, computed as p, unref as q, renderList as r, createStaticVNode as s, toDisplayString as t, useThemeLocaleData as u, useRouteLocale as v, withCtx as w, usePageFrontmatter as x, isArray as y, useSiteLocaleData as z };
