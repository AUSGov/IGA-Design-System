...
const pagesData$1 = {
  ...
  "v-be99661e": () => __vitePreload(() => import(
    /* webpackChunkName: "v-be99661e" */
    "./typography.html.fe83f1ff.js"
  ), true ? [] : void 0).then(({ data }) => data),
  "v-1020f180": () => __vitePreload(() => import(
    /* webpackChunkName: "v-1020f180" */
    "./index.html.111478c9.js"
  ), true ? [] : void 0).then(({ data }) => data),
  "v-c4dcb49c": () => __vitePreload(() => import(
    /* webpackChunkName: "v-c4dcb49c" */
    "./banners.html.7c538c39.js"
  ), true ? [] : void 0).then(({ data }) => data),
  "v-285a8fe0": () => __vitePreload(() => import(
    /* webpackChunkName: "v-285a8fe0" */
    "./entity-bar.html.04cfb658.js"
  ), true ? [] : void 0).then(({ data }) => data),
...
var clientAppEnhance4 = ({ app }) => {
  app.component("ArrowsList", defineAsyncComponent(() => __vitePreload(() => import("./ArrowsList.5958f946.js"), true ? [] : void 0))), app.component("Card", defineAsyncComponent(() => __vitePreload(() => import("./Card.dd8e71b1.js"), true ? [] : void 0))), app.component("Cards", defineAsyncComponent(() => __vitePreload(() => import("./Cards.31799a90.js"), true ? [] : void 0))), app.component("ColorTile", defineAsyncComponent(() => __vitePreload(() => import("./ColorTile.517e8468.js"), true ? [] : void 0))), app.component("ColorTiles", defineAsyncComponent(() => __vitePreload(() => import("./ColorTiles.8a6dbe44.js"), true ? [] : void 0))), app.component("Columns", defineAsyncComponent(() => __vitePreload(() => import("./Columns.48691c0f.js"), true ? [] : void 0))), app.component("ImageMap", defineAsyncComponent(() => __vitePreload(() => import("./ImageMap.3b4d1cbd.js"), true ? [] : void 0))), app.component("SubMenuCards", defineAsyncComponent(() => __vitePreload(() => import("./SubMenuCards.94b4a761.js"), true ? [] : void 0))), app.component("TwoCards", defineAsyncComponent(() => __vitePreload(() => import("./TwoCards.d7536a48.js"), true ? [] : void 0)));
};
...
export { Transition as $, h as A, withBase as B, ClientOnly as C, toRefs as D, useRouter as E, Fragment as F, isActiveSidebarItem as G, ref as H, withDirectives as I, vShow as J, _sfc_main$b as K, useSidebarItems as L, _sfc_main$9 as M, renderSlot as N, isLinkHttp as O, isLinkMailto as P, isLinkTel as Q, resolveRepoType as R, isString$1 as S, useNavLink as T, useSiteData as U, onMounted as V, onUnmounted as W, _sfc_main$6 as X, PageHeader as Y, _sfc_main$3 as Z, _export_sfc as _, createBaseVNode as a, PageFooter as a0, usePageData as a1, resolveComponent as b, createElementBlock as c, createVueApp, createCommentVNode as d, createBlock as e, createVNode as f, withModifiers as g, defineComponent as h, useRoute as i, computed as j, unref as k, createTextVNode as l, createStaticVNode as m, normalizeStyle as n, openBlock as o, useRouteLocale as p, usePageFrontmatter as q, renderList as r, isArray as s, toDisplayString as t, useThemeLocaleData as u, useSiteLocaleData as v, withCtx as w, useDarkMode as x, normalizeClass as y, _sfc_main$c as z };
